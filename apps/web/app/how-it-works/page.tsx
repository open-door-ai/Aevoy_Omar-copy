...
const faqs = [
  {
    q: "Is this a chatbot?",
    a: "No. Chatbots answer questions. Anticipy does things. It opens a real browser, navigates real websites, fills real forms, and makes real phone calls. You get results, not responses.",
  },
  {
      ...
      <footer className="py-12 bg-stone-950 text-stone-500">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p>&copy; 2026 Anticipy. All rights reserved.</p>
