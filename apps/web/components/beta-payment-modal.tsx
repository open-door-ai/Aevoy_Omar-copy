      ...
      <Card className="w-full max-w-md animate-in fade-in zoom-in duration-300">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4 text-sm">
              <p className="font-medium text-purple-900 mb-1">Beta User Benefits:</p>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-gray-500">Optional payment info</span>
              </div>
            </div>

            <div className="space-y-3 opacity-60">
              <div className="space-y-2">
                <Label htmlFor="card" className="text-gray-500">Card Number (optional)</Label>
                <Input
                  id="card"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label htmlFor="expiry" className="text-gray-500">Expiry (optional)</Label>
                  <Input
                    id="expiry"
                    placeholder="MM/YY"
                    value={expiry}
                ...
                <div className="space-y-2">
                  <Label htmlFor="cvc" className="text-gray-500">CVC (optional)</Label>
                  <Input
                    id="cvc"
                    placeholder="123"
                    value={cvc}
