...
export class ProactiveEngagementEngine {
  ...
  private formatDailyDigestEmail(digest: DailyDigest): string {
    return `
<h2>Your Daily Aurora Digest</h2>
...
<p><em>This digest was automatically generated by your Aurora AI. Reply to this email to interact with me!</em></p>
    `.trim();
  }
  ...
  private formatWeeklyReportEmail(report: WeeklyReport): string {
    return `
<h2>Your Weekly Aurora Report</h2>
...
<p><em>This report was automatically generated by your Aurora AI. Reply to this email to interact with me!</em></p>
    `.trim();
  }
