...
const DEFAULT_SKILLS: Omit<Skill, "id">[] = [
  ...
  },
  {
    ...
    api_endpoint: null,
    method: "POST",
    input_schema: { filename: "string", sheets: "array", author: "string?", title: "string?", description: "string?" },
    enabled: true,
  },
  {
    ...
    api_endpoint: null,
    method: "POST",
    input_schema: { filename: "string", slides: "array", theme: "string?", author: "string?" },
    enabled: true,
  },
  {
    name: "create_word",
    ...
    api_endpoint: null,
    method: "POST",
    input_schema: { filename: "string", sections: "array", title: "string?", author: "string?" },
    enabled: true,
  },
  {
    name: "create_pdf",
    ...
    api_endpoint: null,
    method: "POST",
    input_schema: { filename: "string", content: "array", title: "string?", author: "string?", pageSize: "string?" },
    enabled: true,
  },
];
