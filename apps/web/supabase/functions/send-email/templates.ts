      ...
      <tr>
        <td style="background-color: #fafaf9; padding: 32px 40px; text-align: center;">
          <p style="font-size: 14px; color: #57534e; margin: 0 0 8px 0;">
            Sent by your AI assistant at <a href="https://aevoy.com" style="color: #8e5ef2; text-decoration: none;">Anticipy</a>
          </p>
          ...
          <p style="font-size: 12px; color: #a8a29e; margin: 0;">
            © 2026 Anticipy. All rights reserved.
          </p>
        </td>
      </tr>
    </table>
...
<tr>
  <td style="padding: 40px;">
    ...
    <p style="font-size: 16px; color: #44403c; margin: 0 0 16px 0; line-height: 1.6;">
      Thanks for signing up for Anticipy, your AI employee that never fails. We're excited to have you on board.
    </p>
    ...
    <p style="font-size: 14px; color: #78716c; margin: 16px 0 0 0; line-height: 1.5;">
      If you didn't create an account with Anticipy, you can safely ignore this email.
    </p>
...
${emailFooter()}
  ...
  return emailLayout(content, 'Confirm your Anticipy account');
}
...
<tr>
  <td style="padding: 40px;">
    ...
    <p style="font-size: 16px; color: #44403c; margin: 0 0 16px 0; line-height: 1.6;">
      We received a request to reset the password for your Anticipy account (${data.userEmail}).
    </p>
...
${emailFooter()}
  ...
  return emailLayout(content, 'Reset your Anticipy password');
}
...
${emailFooter()}
  ...
  return emailLayout(content, 'Your Anticipy sign-in link');
}
...
export function renderTemplate(
  ...
  switch (type) {
    case 'signup':
      subject = 'Confirm your Anticipy account';
      html = confirmEmailTemplate(data);
      break;

    case 'recovery':
      subject = 'Reset your Anticipy password';
      html = resetPasswordTemplate(data);
      break;

    case 'magic_link':
      subject = 'Your Anticipy sign-in link';
