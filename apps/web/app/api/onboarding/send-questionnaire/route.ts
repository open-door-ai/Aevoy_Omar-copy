...
export async function POST() {
  ...
  try {
    const emailRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Anticipy AI <hello@aevoy.com>",
        to: [userEmail],
        ...
        html: `
          <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px 16px;">
            ...
            <p style="color: #444; line-height: 1.6;">
              To help your Anticipy AI assistant work better for you, we'd love to learn a bit about you.
            ...
            <div style="background: #f5f5f0; border-radius: 12px; padding: 24px; margin: 24px 0;">
              ...
              <ol style="color: #444; line-height: 2;">
                ...
                <li><strong>Any accounts you'd like Anticipy to help manage?</strong>
