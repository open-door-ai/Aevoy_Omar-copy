  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
        <h2 style="color: #1c1917; margin-bottom: 8px;">Your Anticipy Demo Result</h2>
        ...
        <p style="color: #a8a29e; font-size: 12px; margin: 0;">
          This was a demo from <a href="https://aevoy.com" style="color: #78716c;">Anticipy</a>.
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Anticipy Demo <demo@aevoy.com>',
        to: [email],
        subject: 'Your Anticipy Demo Result',
        html: htmlBody,
      }),
    });
