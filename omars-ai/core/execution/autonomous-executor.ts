...
import { ExecutionPlan, ExecutionStep } from './planning.js';
...
export class AutonomousExecutor {
  ...
  async execute(page: Page, plan: ExecutionPlan): Promise<ExecutionResult> {
  ...
  private async executeStep(step: ExecutionStep, page: Page): Promise<{ success: boolean; error?: string; data?: any }> {
    try {
      switch (step.type) {
        case 'navigate':
          if (!step.target) {
...
export function createAutonomousExecutor(): AutonomousExecutor {
