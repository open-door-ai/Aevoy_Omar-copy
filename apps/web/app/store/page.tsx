    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-12">
        ...
        <section className="border border-border rounded-2xl p-8 bg-gradient-to-r from-primary/5 to-purple-500/5 text-center">
          <h2 className="text-xl font-bold mb-2">Build for Aevoy</h2>
          <p className="text-sm text-muted-foreground max-w-md mx-auto mb-4">Create widgets and integrations that extend what Aevoy can do. Earn 70% of revenue from paid apps.</p>
